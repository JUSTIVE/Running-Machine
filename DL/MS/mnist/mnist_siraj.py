...
w_h = init_weights([784, HIDDEN_LAYER], "w_h")
w_h2 = init_weights([HIDDEN_LAYER, HIDDEN_LAYER], "w_h2")
w_o = init_weights([HIDDEN_LAYER, 10], "w_o")
...
with tf.Session() as sess:
    ...
    writer = tf.summary.FileWriter("./siraj/", sess.graph) # for 0.8
